...
// BlockSubmitDialogMorph ////////////////////////////////////////////////////

// BlockSubmitDialogMorph inherits from DialogBoxMorph:

BlockSubmitDialogMorph.prototype = new DialogBoxMorph();
BlockSubmitDialogMorph.prototype.constructor = BlockSubmitDialogMorph;
BlockSubmitDialogMorph.uber = DialogBoxMorph.prototype;

// BlockSubmitDialogMorph constants:

BlockSubmitDialogMorph.prototype.key = 'blockSubmit';

// BlockSubmitDialogMorph instance creation:

function BlockSubmitDialogMorph(serializer, blocks) {
    this.init(serializer, blocks);
}

BlockSubmitDialogMorph.prototype.init = function (serializer, blocks) {
    var myself = this;
    ...
    // initialize inherited properties:
    BlockSubmitDialogMorph.uber.init.call(
        this,
        null, // target
        function () {myself.submitBlocks(); },
        null // environment
    );

    // override inherited properites:
    this.labelString = 'Submit blocks';
    this.createLabel();
...
BlockSubmitDialogMorph.prototype.buildContents = function () {
    var palette, x, y, block, checkBox, lastCat,
        myself = this,
        padding = 4;
...
BlockSubmitDialogMorph.prototype.popUp = function (wrrld) {
    var world = wrrld || this.target.world();
    if (world) {
        BlockSubmitDialogMorph.uber.popUp.call(this, world);
        this.handle = new HandleMorph(
            this,
            200,
            220,
...
// BlockSubmitDialogMorph menu

BlockSubmitDialogMorph.prototype.userMenu = function () {
    var menu = new MenuMorph(this, 'select');
    menu.addItem('all', 'selectAll');
    menu.addItem('none', 'selectNone');
    return menu;
...
BlockSubmitDialogMorph.prototype.selectAll = function () {
    this.body.contents.children.forEach(function (checkBox) {
        if (!checkBox.state) {
            checkBox.trigger();
        }
...
BlockSubmitDialogMorph.prototype.selectNone = function () {
    this.blocks = [];
    this.body.contents.children.forEach(function (checkBox) {
        checkBox.refresh();
    });
...
BlockSubmitDialogMorph.prototype.submitBlocks = function () {
    var str = this.serializer.serialize(this.blocks, true), // for library
        ide = this.world().children[0];
...
// BlockSubmitDialogMorph layout

BlockSubmitDialogMorph.prototype.fixLayout
    = BlockEditorMorph.prototype.fixLayout;
